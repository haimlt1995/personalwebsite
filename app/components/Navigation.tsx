      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden md:flex md:items-center md:space-x-8">
            <a href="#about" className="text-sm font-medium text-slate-300 hover:text-blue-300 transition-colors">
              About
            </a>
            <a href="#contact" className="text-sm font-medium text-slate-300 hover:text-blue-300 transition-colors">
              Contact
            </a>
          </div>
        </div>
